...
from database import close_db, inicializar_banco # Importa funções do módulo database
from auth import bp as auth_bp, login_required # Importa o blueprint de autenticação e o decorador
from properties import bp as properties_bp # Importa o blueprint de imóveis
from admin import bp as admin_bp, admin_required # Importa o blueprint de admin e o decorador
...
def inject_usuario():
    ...
    user_id = g.get('usuario_id') # Usa g.get para evitar KeyError se não estiver setado
    if user_id:
